...
public final class ListParameter extends Parameter {
    ...
    /**
     * Creates a new instance with given field name.
0     *
     * @param fieldName the field name to order by.
     * @return a new instance.
     */
    public static ListParameter create(@NonNull final FieldName fieldName) {
        ListParameter instance = new ListParameter();
        instance.order(fieldName);
        return instance;
    }
